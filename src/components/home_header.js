...
const HomeHeader = ({title, description})  => (
  <div className="min-w-sm mt-0 mx-0 mb-3">
    <img src={banner} className="h-48 md:h-64 lg:h-72 w-full object-cover object-center" />
    <div className="-mt-12 flex items-center justify-around">
      <img src={logo} className="h-24 w-24 rounded-full object-cover object-center lg:h-32 lg:w-32" />
    </div>
