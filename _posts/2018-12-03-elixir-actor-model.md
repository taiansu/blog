...
image: /assets/post_img/2018-12-03-elixir-actor-model/title-compress.jpg
---
...
![](/assets/post_img/2018-12-03-elixir-actor-model/mailbox.png)
...
![](/assets/post_img/2018-12-03-elixir-actor-model/scheduler.png)

這麼一來，就算系統中有 process 需要長時間的運算，也能保證其它的 process 依然可以取得 CPU 資源，將工作先執行完。

![](/assets/post_img/2018-12-03-elixir-actor-model/tasks.png)
