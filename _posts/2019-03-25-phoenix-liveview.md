...
得益於 Elixir / Erlang 優異的平行處理能力，Phoenix Channel 有在  55,000 使用者同時連線 websocket 的情況下，廣播訊息 至200 人的聊天室裡平均 0.24 秒的[記錄]()。建構於其上的 Phoenix LiveView 甚至在官方 demo 裡放了一個 server side rendering 的動畫範例 **rainbow** ，純靠 server side 不斷的將更新的 div 推送到前端製造動畫效果。
