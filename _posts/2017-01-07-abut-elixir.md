...
自從 2014 被 [Dave Thomas 推坑](../2014-07-26-a_sip_of_elixir/)至今也好一陣子了，前些時候還被 tag
...
在 Elixir/Erlang 中，每段程式會在獨立的輕量 process 裡平行運作，不共享記憶體。各自透過 message 來交換資訊。因此系統在一台機器上運作，跟在一百機器上運作的方式完全相同，水平擴充起來非常容易。在 Elixir/Erlang 中使用 process，就如同在 OO 語言裡使用 object instance 一般，是非常基本的手法。
...
* 跟 [Micky Chen](https://www.facebook.com/mickey.1985) 一起<s>撐</s>辦到[第九場](http://elixirtw.kktix.cc/events/taipei201701) Elixir Taiwan
